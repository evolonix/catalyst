...
const initialOrdersData: OrderData[] = [
  {
    ...
    url: '/orders/3000',
    date: 'May 9, 2024',
    amount: { usd: '$80.00', cad: '$109.47', fee: '$3.28', net: '$106.19' },
    payment: {
      transactionId: 'ch_2HLf8DfYJ0Db7asfCC5T546TY',
      card: { number: '1254', type: 'American Express', expiry: '01 / 2025' },
    },
    customer: {
  ...
  },
  {
    ...
    url: '/orders/3001',
    date: 'May 5, 2024',
    amount: { usd: '$299.00', cad: '$409.13', fee: '$12.27', net: '$396.86' },
    payment: {
      transactionId: 'ch_1KLf7AsYJ0Dda7fs3CC5d46TY',
      card: { number: '3897', type: 'Visa', expiry: '06 / 2024' },
    },
    customer: {
      name: 'Michael Foster',
  ...
  },
  {
    ...
    url: '/orders/3002',
    date: 'Apr 28, 2024',
    amount: { usd: '$150.00', cad: '$205.25', fee: '$6.15', net: '$199.10' },
    payment: {
      transactionId: 'ch_2DLf5AsYJ0Ddb7fs3CC5d46TY',
      card: { number: '7421', type: 'Mastercard', expiry: '12 / 2026' },
    },
    customer: {
      name: 'Dries Vincent',
  ...
  },
  {
    ...
    payment: {
      ...
      card: { number: '5683', type: 'Visa', expiry: '06 / 2024' },
    },
    customer: {
      name: 'Lindsay Walton',
  ...
  },
  {
    ...
    url: '/orders/3004',
    date: 'Apr 18, 2024',
    amount: { usd: '$114.99', cad: '$157.34', fee: '$4.72', net: '$152.62' },
    payment: {
      transactionId: 'ch_4HLf7DfYJ0Db78fas3C5d6TY',
      card: { number: '9576', type: 'Visa', expiry: '01 / 2025' },
    },
    customer: {
      name: 'Courtney Henry',
  ...
  },
  {
    ...
    payment: {
      ...
      card: { number: '2310', type: 'Visa', expiry: '08 / 2024' },
    },
    customer: {
      name: 'Tom Cook',
  ...
  },
  {
    ...
    payment: {
      ...
      card: { number: '6942', type: 'Mastercard', expiry: '06 / 2024' },
    },
    customer: {
  ...
  },
  {
    ...
    payment: {
      ...
      card: { number: '8473', type: 'Visa', expiry: '08 / 2024' },
    },
    customer: {
  ...
  },
  {
    ...
    payment: {
      ...
      card: { number: '5061', type: 'Visa', expiry: '11 / 2026' },
    },
    customer: {
      name: 'Floyd Miles',
  ...
  },
  {
    ...
    payment: {
      ...
      card: { number: '3129', type: 'American Express', expiry: '06 / 2025' },
    },
    customer: {
      name: 'Emily Selman',
  ...
  },
  {
    ...
    payment: {
      ...
      card: { number: '6498', type: 'Visa', expiry: '06 / 2024' },
    },
    customer: {
      name: 'Kristin Watson',
  ...
  },
  {
    ...
    payment: {
      ...
      card: { number: '1732', type: 'American Express', expiry: '08 / 2024' },
    },
    customer: {
      name: 'Emma Dorsey',
  ...
  },
  {
    ...
    payment: {
      ...
      card: { number: '8256', type: 'Visa', expiry: '01 / 2024' },
    },
    customer: {
      name: 'Alicia Bell',
  ...
  },
  {
    ...
    payment: {
      ...
      card: { number: '4901', type: 'Mastercard', expiry: '06 / 2025' },
    },
    customer: {
      name: 'Jenny Wilson',
  ...
  },
  {
    ...
    payment: {
      ...
      card: { number: '7365', type: 'Visa', expiry: '06 / 2024' },
    },
    customer: {
      name: 'Anna Roberts',
  ...
  },
  {
    ...
    payment: {
      ...
      card: { number: '2849', type: 'Visa', expiry: '06 / 2024' },
    },
    customer: {
  ...
  },
  {
    ...
    payment: {
      ...
      card: { number: '6132', type: 'Mastercard', expiry: '01 / 2026' },
    },
    customer: {
      name: 'Jeffrey Webb',
  ...
  },
  {
    ...
    payment: {
      ...
      card: { number: '9054', type: 'Mastercard', expiry: '06 / 2024' },
    },
    customer: {
      name: 'Kathryn Murphy',
  ...
  },
  {
    ...
    payment: {
      ...
      card: { number: '4287', type: 'Mastercard', expiry: '06 / 2024' },
    },
    customer: {
  ...
  },
  {
    ...
    payment: {
      ...
      card: { number: '1765', type: 'Visa', expiry: '06 / 2025' },
    },
    customer: {
  ...
  },
  {
    ...
    payment: {
      ...
      card: { number: '5923', type: 'Visa', expiry: '12 / 2024' },
    },
    customer: {
      name: 'Angela Fisher',
  ...
  },
  {
    ...
    payment: {
      ...
      card: { number: '3014', type: 'Visa', expiry: '06 / 2024' },
    },
    customer: {
      name: 'Blake Reid',
  ...
  },
  {
    ...
    payment: {
      ...
      card: { number: '8642', type: 'American Express', expiry: '11 / 2026' },
    },
    customer: {
      name: 'Hector Gibbons',
  ...
  },
  {
    ...
    payment: {
      ...
      card: { number: '5173', type: 'Visa', expiry: '12 / 2025' },
    },
    customer: {
  ...
  },
  {
    ...
    payment: {
      ...
      card: { number: '6298', type: 'Mastercard', expiry: '06 / 2024' },
    },
    customer: {
  ...
  },
  {
    ...
    payment: {
      ...
      card: { number: '9401', type: 'American Express', expiry: '08 / 2025' },
    },
    customer: {
      name: 'Chelsea Hagon',
...
let ordersStore: OrderData[] | null = null;

async function getOrdersStore(): Promise<OrderData[]> {
  if (ordersStore === null) {
    ordersStore = [...initialOrdersData];
  }
  return ordersStore;
}
...
export async function getOrders(): Promise<Order[]> {
  const ordersData = await getOrdersStore();
  const orders: Order[] = await Promise.all(
    ordersData.map(async (orderData) => ({
      ...orderData,
      event: await getEvent(orderData.eventId),
    }))
  );
  return orders;
}
...
export async function createOrder(input: CreateOrderInput): Promise<Order> {
  ...
  const country = countries.find((c) => c.name === input.customerCountry);

  const maxId = ordersData.reduce((max, o) => Math.max(max, o.id), 0);
  const newId = maxId + 1;

  // Calculate amount based on quantity (using a base price of $50 per ticket for demo)
  const basePrice = 50;
  const totalUsd = basePrice * input.quantity;
  const cadRate = 1.37;
  const totalCad = totalUsd * cadRate;
  const fee = totalCad * 0.03;
  const net = totalCad - fee;
  ...
  const transactionId = `ch_${Math.random().toString(36).substring(2, 15)}${Math.random().toString(36).substring(2, 15)}`.substring(0, 28);
  ...
  const newOrderData: OrderData = {
    ...
    payment: {
      transactionId,
      card: {
        number: input.cardNumber.slice(-4),
        type: input.cardType,
    ...
    customer: {
      ...
      countryFlagUrl: country?.flagUrl || '/flags/us.svg',
    },
